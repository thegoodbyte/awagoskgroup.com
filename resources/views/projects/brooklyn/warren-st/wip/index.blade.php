                                    ...
                                    <div class="portfolio-item">
                                        <div class="project-grid-wrapper">
                                            <a class="project-grid-item-img-link" href="{{  route('projects.brooklyn.warren-st.wip.cabinetry') }}">
                                                <div class="project-grid-item-img">
                                                    <img   src="#" data-lazy-src="/img/projects-galleries/brooklyn/warren-st/galleries/wip/cabietry/thumbs/category-face.JPG"
                                                           class="s-img-switch wp-post-image wp-post-image" alt="seascape-villa image" />
                                                </div>
                                            </a>
                                            <div class="project-grid-item-content">
                                ...
                                <div class="portfolio-item-wrapp">
                                    <div class="portfolio-item">
                                        <div class="project-grid-wrapper">
                                            ...
                                            <div class="project-grid-item-content">
                                                <h4 class="project-grid-item-title"><a href="{{  route('projects.brooklyn.warren-st.wip.doors-windows') }}">WORDS / WINDOWS</a></h4>
                                                <div class="project-grid-item-category">
                                                    Luxury Meets Modern Functionality</div>
