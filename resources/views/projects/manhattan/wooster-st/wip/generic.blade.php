    ...
    <div class="row-fluid no-padd">
        <div class="col-sm-6 no-padd-inner">
            <div class="heading no-padd-top-bottom left dark">
                ...
                <div class="subtitle  text-alight-lft"><a href = "{{ route('projects.manhattan.wooter-st.index') }}">Wooster St</a> > <a href = "{{ route('projects.manhattan.wooster-st.wip.index') }}">IN PROGRESS</a> > GENERIC WORK </div>
